...
import com.tiny.cluster.vo.XxlRpcAdminRegistryDataParamVO;
import com.tiny.cluster.vo.XxlRpcAdminRegistryParamVO;
...
public class ApiController {
    ...
    @ResponseBody
    public Result<String> registry(@RequestBody(required = false) String data){

        // parse data
        XxlRpcAdminRegistryParamVO registryParamVO = null;
        try {
            registryParamVO = (XxlRpcAdminRegistryParamVO) JsonUtil.parse(data, XxlRpcAdminRegistryParamVO.class);
        } catch (Exception e) { }
    ...
    @ResponseBody
    public Result<String> remove(@RequestBody(required = false) String data){
    ...
    @ResponseBody
    public Result<Map<String, List<String>>> discovery(@RequestBody(required = false) String data) {
