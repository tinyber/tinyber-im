...
import client.packet.ImTcpPacket;
...
public class HelloClientStarter {
	//服务器节点
	public static Node serverNode = new Node("222.186.136.66",9325);
	...
	private static void send() throws Exception {
		ImTcpPacket packet = new ImTcpPacket();
		packet.setBody("hello world".getBytes(ImTcpPacket.CHARSET));
		Tio.bindUser(clientChannelContext,"1111");
